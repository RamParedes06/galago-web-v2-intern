      ...
      <div className="privacy-wrapper">
        ...
        <div className="privacy-container d-flex flex-column gap-4">
          ...
          <div className="privacy-content footnote-medium d-flex flex-column gap-4">
            <p>
              This Privacy Statement describes how we collect, use, disclose,
              and protect your personal information when you use our travel and
              hotel booking website. By using our services, you agree to the
            ...
            <div className="d-flex flex-column gap-4">
              <div className="privacy-group">
                ...
                <li>
                  When you make a booking, we collect personal information such
                  as your name, contact details, payment information, and travel
                  preferences.
                </li>
              ...
              <div className="privacy-group">
                ...
                <li>
                  We use the collected information to facilitate flight and
                  hotel bookings, process payments, and provide customer
                  support.
                </li>
                <li>
              ...
              <div className="privacy-group">
                ...
                <li>
                  Payment information is securely processed by third-party
                  payment processors.
                </li>
                <li>
              ...
              <div className="privacy-group">
                ...
                <li>
                  Despite our efforts, no online transmission or storage method
              ...
              <div className="privacy-group">
                ...
                <li>
                  ...
                  information about your browsing behavior. You can control
                  cookie preferences through your browser settings.
                </li>
                <li>
                  We use cookies for analytics, personalized content, and
              ...
              <div className="privacy-group">
                ...
                <li>
                  ...
                  13. We do not knowingly collect or store information from
                  children.
                </li>
              </div>
